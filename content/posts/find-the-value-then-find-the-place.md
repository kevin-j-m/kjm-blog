...
My pair and I were wrangling some logic in a controller. We decomposed what was a long public action into smaller private methods. We discovered we could bundle a few of these methods up into a domain concept. We thought of creating a class for these. We even had a name for it! Then my pair asked the question that prompted my uncaring response:
