...
date = 2026-03-14T03:14:16-04:00
tags = ["ruby"]
...
A formatter accepts a comparison of result sets. It organizes that data in some readable format. It's expected to respond to a `format` method which returns a string. SimpleCov::Compare ships with one formatter, providing a [markdown](https://github.com/kevin-j-m/simplecov-compare/blob/b8b2a2afd3b663dde64f4bb8eecb69cf8cdd544e/lib/simplecov/compare/formatter/markdown_formatter.rb) summation of the results.
