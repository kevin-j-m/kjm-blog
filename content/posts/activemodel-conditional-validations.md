...
date = 2026-07-20T09:00:22-04:00
tags = ["ruby", "rails"]
...
You may have seen validations that only apply during certain lifecycle events. Perhaps you've seen something like a field that only needs to be present when creating an instance. Or another attribute must be greater than one when updating the record.
