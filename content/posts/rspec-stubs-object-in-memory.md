...
date = 2024-09-09T15:00:10-04:00
...
On the flip side, one could also argue that this test is tying us to a particular implementation. If `DraftPost.publish_all` changed to instead use `Post.where(draft: true)`, then this test will no longer work. Unfortunately, there is no *right* answer. We must consider the trade-offs we're willing to make to achieve our goal. What ✨magic✨ you're interested in maintaining is up to you.
